...
const Login = () => {
    ...
    return (
        <div className='w-full h-screen flex' > 
            ...
            <div className='w-1/2 h-full bg-[#1a1a1a] bg-opacity-50 flex flex-col p-20 justify-center'>
                <div className='w-full flex flex-col max-w-[450px] mx-auto'>
                    {/* Header section with title and welcome message */}
                    <div className='w-full flex flex-col mb-10 text-white'>
                        <h3 className='text-4xl font-bold mb-2'>Log in to Playstation</h3>
                    </div>

                    {/* Input fields for email and password */}
                    <div className='w-full flex flex-col mb-6'>
                        <p className='text-lg mb-4'>Log-In ID(Email Address)</p>
                        <input 
                            type='email'
                            placeholder='Email'
                    ...
                    {/* <button
                        className='w-full bg-grey text-black font-semibold rounded-md p-4 text-center flex items-center justify-center cursor-pointer mt-7'
